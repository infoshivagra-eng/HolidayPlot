        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-lg">
             ...
             <button 
                ...
                className={`px-3 py-1.5 text-xs font-bold rounded-md transition-colors ${dateRange === '90d' ? 'bg-white shadow-sm text-brand-blue' : 'text-gray-500 hover:text-gray-900'}`}
             >90 Days</button>
          </div>
          
          <div className="flex items-center gap-2 border-l border-gray-300 pl-3">
             <label className="flex items-center gap-2 text-xs font-bold text-gray-600 cursor-pointer">
                <input type="checkbox" checked={compareMode} onChange={e => setCompareMode(e.target.checked)} className="rounded text-brand-blue focus:ring-brand-blue"/>
                Compare Previous
             </label>
          </div>
